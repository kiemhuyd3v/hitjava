...
// Slot8/Slot8Script/Slot8History.ts
...
var Slot8History = /** @class */ (function (_super) {
    ...
    Slot8History.prototype.loadData = function () {
        ...
        Http_1.default.get(Configs_1.default.App.API, { "c": 137, "p": this.page, "un": Configs_1.default.Login.Nickname, "gn": "ROLL_ROYE" }, function (err, res) {
    ...
    __decorate([
        property(cc.Label)
    ], Slot8History.prototype, "lblPage", void 0);
    __decorate([
        property(cc.Node)
    ], Slot8History.prototype, "itemTemplate", void 0);
    Slot8History = __decorate([
        ccclass
    ], Slot8History);
    return Slot8History;
}(Dialog_1.default));
